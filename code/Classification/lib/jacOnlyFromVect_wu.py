...
class JaccardCoefficient:
    ...
    def __init__(self,**kwargs):
        ...
        self.f2_out_normal = kwargs["outFolder"]+'//normal.csv'
        self.f2_out_generalised = kwargs["outFolder"]+'//generalised.csv'
        self.f2_out_wu = kwargs["outFolder"]+'//wu.csv'
        self.f2_out_sarika1 = kwargs["outFolder"]+'//sarika.csv'
        self.f2_out_cosine = kwargs["outFolder"]+'//cosine.csv'
